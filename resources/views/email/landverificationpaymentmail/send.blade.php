          ...
          <tr>
            <td class="content" style="background-color:#e0e0e0; padding:30px; color:#000000; font-size:14px; line-height:22px;">
              ...
              <table role="presentation" cellpadding="4" cellspacing="0" border="0" width="100%" style="font-size:14px; color:#000000;">
                <tr>
                  <td width="40%">Nomor Dokumen</td><td width="2%">:</td><td>{{ $dataArray['verification_no'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="40%">No. Buku</td><td width="2%">:</td><td>{{ $dataArray['book_no'] }}</td>
                </tr>
                <tr>
                  <td width="40%">No. Form Berkas Masuk</td><td width="2%">:</td><td>{{ $dataArray['incoming_form_no'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Nominal SPH (Rp./m2)</td><td width="2%">:</td><td>{{ $dataArray['sph_amt_m2'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Nominal PPh</td><td width="2%">:</td><td>{{ $dataArray['pph_amt'] }}</td>
                </tr>
                <tr>
                  <td width="40%">No. Form Pengajuan PPh & BPHTB</td><td width="2%">:</td><td>{{ $dataArray['submission_tax_no'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Tanggal Bayar PPh</td><td width="2%">:</td><td>{{ $dataArray['pph_payment_date'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Tanggal Pendaftaran Validasi PPh</td><td width="2%">:</td><td>{{ $dataArray['pph_reg_date'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Tanggal Validasi</td><td width="2%">:</td><td>{{ $dataArray['pph_validation_date'] }}</td>
                </tr>
              </table>
