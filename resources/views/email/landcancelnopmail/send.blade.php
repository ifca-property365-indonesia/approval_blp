        ...
        <table role="presentation" width="100%" class="main-container" style="max-width:600px; background-color:#ffffff; border-collapse:collapse;">
          ...
          <tr>
            <td class="content" style="background-color:#e0e0e0; padding:30px; color:#000000; font-size:14px; line-height:22px;">
              ...
              <p style="margin:0 0 15px;">Tolong berikan persetujuan untuk proses Pembatalan NOP dengan detail :</p>

              <!-- Detail Table -->
              <table role="presentation" cellpadding="4" cellspacing="0" border="0" width="100%" style="font-size:14px; color:#000000;">
                <tr>
                  <td width="40%">Nomor Dokumen</td><td width="2%">:</td><td>{{ $dataArray['doc_no'] }}</td>
                </tr>
                <tr>
                  <td width="40%">NOP </td><td width="2%">:</td><td>{{ $dataArray['nop_no'] }}</td>
                </tr>
                <tr>
                  <td width="40%">>Nama pada SPPT</td><td width="2%">:</td><td>{{ $dataArray['sppt_name'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Nama Pemilik</td><td width="2%">:</td><td>{{ $dataArray['owner_name'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Tanggal Cancel NOP</td><td width="2%">:</td><td>{{ $dataArray['transaction_date'] }}</td>
                </tr>
                <tr>
                  <td width="40%">Alasan Pembatalan</td><td width="2%">:</td>
